...
* **Interactive Ternary Visualization:** Maps 3D secondary stat combinations ($Haste + Mastery + Crit = \text{Constant Budget}$) onto an interactive 2D ternary plot built with Plotly.
